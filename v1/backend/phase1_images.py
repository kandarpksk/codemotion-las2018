...
count = 0
for e1 in pts:
	along_x = [(e1, e2) for e2 in pts[count:] if smallSlope(e1, e2, 'x', 1)]
	along_y = [(e1, e2) for e2 in pts[count:] if smallSlope(e1, e2, 'y', 1)]
	for pair in along_x:
